...
from portifolio.api.serializers.secaosobre import SecaoSobreSerializer
from portifolio.models import SecaoSobre


class SecaoSobreViewAPI(ModelViewSet):
    ...
    queryset = SecaoSobre.objects.select_related().all()
    serializer_class = SecaoSobreSerializer
