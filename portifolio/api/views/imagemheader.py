...
from portifolio.api.serializers.imagemheader import ImagemHeaderSerializer
from portifolio.models import ImagemHeader


class ImagemHeaderViewAPI(ModelViewSet):
    ...
    queryset = ImagemHeader.objects.select_related().all()
    serializer_class = ImagemHeaderSerializer
