...
from portifolio.api.serializers.secaocontato import SecaoContatoSerializer
from portifolio.models import SecaoContato


class SecaoContatoViewAPI(ModelViewSet):
    ...
    queryset = SecaoContato.objects.select_related().all()
    serializer_class = SecaoContatoSerializer
    filter_backends = [filters.SearchFilter, filters.OrderingFilter]
    search_fields = []
    ordering_fields = []


class SecaoContatoReadOnlyAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
