...
from portifolio.api.serializers.mensagemcontato import MensagemContatoSerializer
from portifolio.models import MensagemContato


class MensagemContatoViewAPI(ModelViewSet):
    ...
    queryset = MensagemContato.objects.select_related().all()
