...
from portifolio.api.serializers.dadosprincipais import DadosPrincipaisSerializer
from portifolio.models import DadosPrincipais


class DadosPrincipaisViewAPI(ModelViewSet):
    ...
    queryset = DadosPrincipais.objects.select_related().all()
    serializer_class = DadosPrincipaisSerializer
    filter_backends = [filters.SearchFilter, filters.OrderingFilter]
    search_fields = []
    ordering_fields = []


class DadosPrincipaisReadOnlyAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
