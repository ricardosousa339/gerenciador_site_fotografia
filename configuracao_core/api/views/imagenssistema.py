...
from configuracao_core.api.serializers.imagenssistema import ImagensSistemaSerializer
...
class ImagensSistemaReadOnlyAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
