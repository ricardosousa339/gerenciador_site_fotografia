...
from configuracao_core.api.serializers.imagemgenerica import ImagemGenericaSerializer
...
class ImagemGenericaReadOnlyAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
