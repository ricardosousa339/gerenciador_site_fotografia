from configuracao_core.forms.dadosgerais import DadosGeraisForm
...
class DadosGeraisListView(BaseListView):
    ...
    list_display = ["endereco", "horario_atendimento", "telefone"]
    search_fields = ["endereco", "horario_atendimento", "telefone"]
    paginate_by = 10
