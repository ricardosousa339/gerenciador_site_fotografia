from configuracao_core.forms.gestor import GestorForm
...
class GestorListView(BaseListView):
    ...
    list_display = ["assinatura", "email", "funcao", "nome", "telefone"]
    search_fields = ["assinatura", "email", "funcao", "nome", "telefone"]
    paginate_by = 10
