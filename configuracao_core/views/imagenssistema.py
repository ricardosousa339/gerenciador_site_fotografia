from configuracao_core.forms.imagenssistema import ImagensSistemaForm
...
class ImagensSistemaListView(BaseListView):
    ...
    list_display = ["favicon", "footer", "footer_principal", "login"]
    search_fields = ["favicon", "footer", "footer_principal", "login"]
    paginate_by = 10
