...
from configuracao_core.views.dadosgerais import (
...
from configuracao_core.views.gestor import (
    GestorCreateView,
    GestorDeleteView,
    GestorDetailView,
    GestorListView,
...
from configuracao_core.views.imagemgenerica import (
...
from configuracao_core.views.imagemlogin import (
...
from configuracao_core.views.imagenssistema import (
...
from configuracao_core.views.index import Configuracao_CoreIndexTemplateView
from configuracao_core.views.logosistema import (
...
from configuracao_core.views.redesocial import (
